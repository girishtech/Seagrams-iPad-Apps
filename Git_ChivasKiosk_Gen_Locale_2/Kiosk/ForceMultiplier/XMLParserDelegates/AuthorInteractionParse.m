...
@implementation AuthorInteractionParse
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qualifiedName 
{
    ...
    if([currentParent isEqualToString:@"entry"])
    {
        ...
        if([elementName isEqualToString:@"AuthorInteractionID"]) 
        {
        ...
        else if([elementName isEqualToString:@"AuthorInteractionTypeID"]) 
        {
            [currentEntity setValue:trimmed forKey:elementName];
        }
