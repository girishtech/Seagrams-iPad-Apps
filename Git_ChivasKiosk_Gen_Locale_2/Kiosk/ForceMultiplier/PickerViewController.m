...
-(IBAction)dateChanged
{
    ...
    [selectedValues addObject:[theDatePickerView date] forKey:@"date"];
...
- (void)viewDidLoad {
    ...
    [theDatePickerView setMaximumDate:maxDate];
    
    //[values addObject:[theDatePickerView date] forKey:@"date"];
    //[self.delegate valuesDidChangeTo:values];
